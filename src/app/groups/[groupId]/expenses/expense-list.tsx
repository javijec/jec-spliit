...
function ExpenseListSummary({
  ...
  return (
    <div className="hidden flex-wrap gap-2 px-4 py-2 sm:flex sm:px-5">
      <span className="inline-flex items-center rounded-md border border-border/70 bg-background/80 px-3 py-1 text-[0.7rem] font-medium text-foreground">
        ...
        return (
          <div key={expenseGroup} className="space-y-1.5">
            <div className="px-3 pt-1 sm:px-5">
              <div className="text-sm font-semibold text-muted-foreground/90">
        ...
        <div key={groupIndex} className="space-y-2">
          ...
          {[0, 1].map((index) => (
            <div
              ...
              className="flex items-start justify-between gap-3 rounded-lg border border-border/70 bg-card/90 px-4 py-3 text-sm shadow-sm shadow-black/5"
            >
