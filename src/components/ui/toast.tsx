...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden border bg-background p-5 pr-8 shadow-sm transition-all data-[limited]:hidden data-[swiping]:transition-none data-[starting-style]:animate-in data-[starting-style]:fade-in-0 data-[starting-style]:slide-in-from-top-full data-[starting-style]:sm:slide-in-from-bottom-full data-[ending-style]:animate-out data-[ending-style]:fade-out-80 data-[ending-style]:slide-out-to-right-full",
  {
    variants: {
      variant: {
